...
<b>Note:</b> You should be running version 1.3.6 of the gem command. Run <tt>gem -v</tt> to determine your current version. Run <tt>gem update --system</tt> to upgrade to the latest version.
