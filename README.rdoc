...
The following custom exceptions can be thrown by the library:
...
<tt>UnknownFail</tt>::       An unanticipated error occurred. If this happens consistently, post a GitHub project issue and include the full Exception text.
